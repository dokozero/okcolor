 ...
 */
export default function filterNewContrast(newContrast: ApcaContrast | WcagContrast): ApcaContrast | WcagContrast {
  ...
  else if ($currentContrastMethod.get() === 'wcag' && newContrast === 0) filteredNewContrast = contrastRange.positive.min
