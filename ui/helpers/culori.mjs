...
var prepare = (color, mode) =>
  color === void 0 ? void 0 : typeof color !== 'object' ? parse_default(color) : color.mode !== void 0 ? color : mode ? { ...color, mode } : void 0
...
var definition = {
  ...
  parse: [parseRgb_default, parseHex_default, parseRgbLegacy_default, parseNamed_default, parseTransparent_default, 'srgb'],
  serialize: 'srgb',
  interpolate: {
...
var definition7 = {
  ...
  serialize: (c4) =>
    `hsl(${c4.h || 0} ${c4.s !== void 0 ? c4.s * 100 + '%' : 'none'} ${c4.l !== void 0 ? c4.l * 100 + '%' : 'none'}${
      c4.alpha < 1 ? ` / ${c4.alpha}` : ''
    })`,
  interpolate: {
    h: { use: interpolatorLinear, fixup: fixupHueShorter },
...
var definition12 = {
  ...
  serialize: (c4) =>
    `lab(${c4.l !== void 0 ? c4.l : 'none'} ${c4.a !== void 0 ? c4.a : 'none'} ${c4.b !== void 0 ? c4.b : 'none'}${
      c4.alpha < 1 ? ` / ${c4.alpha}` : ''
    })`,
  interpolate: {
    l: interpolatorLinear,
...
var convertLrgbToOklab = ({ r: r2, g, b, alpha }) => {
  let L = Math.cbrt(0.41222147079999993 * r2 + 0.5363325363 * g + 0.0514459929 * b)
...
function get_Cs(L, a_, b_) {
  ...
  let T_mid =
    ...
    1 /
      (1.6132032 -
        0.68124379 * b_ +
        a_ * (0.40370612 + 0.90148123 * b_ + a_ * (-0.27087943 + 0.6122399 * b_ + a_ * (299215e-8 - 0.45399568 * b_ - 0.14661872 * a_))))
...
var definition19 = {
  ...
  serialize: (c4) =>
    `oklab(${c4.l !== void 0 ? c4.l : 'none'} ${c4.a !== void 0 ? c4.a : 'none'} ${c4.b !== void 0 ? c4.b : 'none'}${
      c4.alpha < 1 ? ` / ${c4.alpha}` : ''
    })`
}
...
var definition20 = {
  ...
  serialize: (c4) =>
    `oklch(${c4.l !== void 0 ? c4.l : 'none'} ${c4.c !== void 0 ? c4.c : 'none'} ${c4.h || 0}${c4.alpha < 1 ? ` / ${c4.alpha}` : ''})`,
  ranges: {
    l: [0, 1],
    c: [0, 0.4],
    h: [0, 360]
...
var mono = (arr) => {
  ...
  for (let i = 0; i < n3; i++) {
    ...
    yp.push(i > 0 ? (sgn(s[i - 1]) + sgn(s[i])) * min(abs2(s[i - 1]), abs2(s[i]), 0.5 * abs2(p4[i])) : void 0)
  }
  return [s, p4, yp]
}
...
var filterInvert = (amt = 1, mode = 'rgb') => {
  let a = clamp2(amt)
  return mapper((v, ch) => (ch === 'alpha' ? v : lerp2(a, 1 - a, v)), mode, true)
}
...
var PROT = [
  ...
  [0.734766, 0.334872, -0.069637, 0.05184, 0.919198, 0.028963, -4928e-6, -4209e-6, 1.009137],
  [0.630323, 0.465641, -0.095964, 0.069181, 0.890046, 0.040773, -6308e-6, -7724e-6, 1.014032],
  [0.539009, 0.579343, -0.118352, 0.082546, 0.866121, 0.051332, -7136e-6, -0.011959, 1.019095],
  [0.458064, 0.679578, -0.137642, 0.092785, 0.846313, 0.060902, -7494e-6, -0.016807, 1.024301],
  [0.38545, 0.769005, -0.154455, 0.100526, 0.829802, 0.069673, -7442e-6, -0.02219, 1.029632],
  [0.319627, 0.849633, -0.169261, 0.106241, 0.815969, 0.07779, -7025e-6, -0.028051, 1.035076],
...
var DEUTER = [
  ...
  [0.760729, 0.319078, -0.079807, 0.090568, 0.889315, 0.020117, -6027e-6, 0.013325, 0.992702],
  [0.675425, 0.43385, -0.109275, 0.125303, 0.847755, 0.026942, -795e-5, 0.018572, 0.989378],
  [0.605511, 0.52856, -0.134071, 0.155318, 0.812366, 0.032316, -9376e-6, 0.023176, 0.9862],
...
var TRIT = [
  ...
  [1.017277, 0.027029, -0.044306, -6113e-6, 0.958479, 0.047634, 6379e-6, 0.248708, 0.744913],
  [1.104996, -0.046633, -0.058363, -0.032137, 0.971635, 0.060503, 1336e-6, 0.317922, 0.680742],
  [1.193214, -0.109812, -0.083402, -0.058496, 0.97941, 0.079086, -2346e-6, 0.403492, 0.598854],
...
function clampChromaInGamut(color, mode = 'lch', targetGamut = 'rgb') {
  const isInGamut = inGamut(targetGamut)

  color = prepare_default(color)
  if (color === void 0 || isInGamut(color)) return color
  let conv = converter_default(color.mode)
  color = converter_default(mode)(color)
  let clamped = { ...color, c: 0 }
  ...
  return conv(isInGamut(clamped) ? clamped : { ...clamped, c: _last_good_c })
}
...
export {
  ...
  smoothstep_default as easingSmoothstep,
  filterBrightness,
  filterContrast,
