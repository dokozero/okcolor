...
// MODIFIED - I added this function as a bridge to the color conversion function as there are some cases that needed to handle data correction to avoid some bugs.
export function colorConversion(from, to, param1, param2, param3) {
    ...
    if (to == "srgb") {
        ...
        // Also, okhsv_to_srgb() return NaN values if we have a black value (param3 = 0) with OkHSV value.
        param2 = clamp(param2, 0.01, 99.9);
        param3 = clamp(param3, 0.01, 99.9);
