  ...
  return (
    <>
      ...
      <div class="colorpicker">
        ...
        <canvas ref={canvasColorPickerOkHSL} class={"colorpicker__canvas" + (colorModel.value == "okhsl" ? "" : " u-display-none")} id="okhsl_sl_canvas" width="257" height="257"></canvas>
        <canvas ref={canvasColorPickerOkHSV} class={"colorpicker__canvas" + (colorModel.value == "okhsv" ? "" : " u-display-none")} id="okhsv_sv_canvas" width="257" height="257"></canvas>
